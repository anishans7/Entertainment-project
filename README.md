...
To use the application, visit [Movies Entertainment App](https://dapper-entertainment-codewithans.netlify.app/) and log in using your Google or Github account to access extra features like reviews and bookmarks.
...
```bash
$ git clone https://github.com/[@anishans7]/movies-entertainment-app.git
```
...
👩‍💻 Anish Ansari [@anishans7](https://github.com/anishans7/Entertainment-apk)
